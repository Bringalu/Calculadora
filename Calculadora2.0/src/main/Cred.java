...
public class Cred {
	...
	private void initialize() {
		...
		frmCrditos.setIconImage(Toolkit.getDefaultToolkit().getImage(Cred.class.getResource("/img/gorilao.jpg")));
		...
		frmCrditos.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		lblCalculadora.setBounds(120, 11, 187, 55);
